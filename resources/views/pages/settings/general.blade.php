<x-dashboard::layout.setting title="General"
    route="dashboard.settings.updateGeneral" locale="{{ $locale}}">
        ...
        <x-dashboard::form.input value="{{$general->site_description[$locale]}}" name='site_description'>site description</x-dashboard::form.input>

        <x-dashboard::form.input value="{{$general->address[$locale]}}" name='address'>Address</x-dashboard::form.input>

        <x-dashboard::form.input value="{{$general->copyrights[$locale]}}" name='copyrights'>copyrights</x-dashboard::form.input>
